[_tb_system_call storage=system/_6m_3w_mail.ks]
...
[glink  color="orange"  storage="6m_3w_mail.ks"  size="20"  text="戻る"  x="13"  y="554"  width=""  height=""  _clickable_img=""  target="*back"  ]
[tb_ptext_show  x="40"  y="119"  size="30"  color="0x000000"  time="0"  text="time就活エージェント"  anim="false"  face="x12y16pxMaruMonica"  edge="undefined"  shadow="undefined"  ]
[clickable  storage="6m_3w_mail.ks"  x="1"  y="92"  width="265"  height="90"  target="*メッセージ3"  _clickable_img=""  ]
[s  ]
*メッセージ3
